-- Better Auth schema for SynergyPlus portal (CONTRACT §2: lives in the 'auth' schema).
-- Generated via: npm run auth:generate  (npx @better-auth/cli generate)
-- Apply once against the shared Postgres before running the portal.
